...
class swim_fpn(nn.Layer):
    def __init__(self,
        ...
        super(swim_fpn, self).__init__()

        # ENCODER
        self.encoder = SwinTransformer(pretrain_img_size=224, embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24], window_size=7,)
...
if __name__ == '__main__':
    ...
    input_tensor = paddle.randn((4, 3, 256, 256))
    ...
    #     window_size=7,)
    #
    # input_tensor = paddle.randn((8, 3, 256, 256))
    # out_put = model(input_tensor)
    # print(out_put[0].shape, out_put[1].shape, out_put[2].shape, out_put[3].shape)
