...
if __name__ == '__main__':
    ...
    #     num_heads=[4, 8, 16, 32],
    #     window_size=12,
    #     pretrained=r'D:\yyc\yycpython\Document_seg\model\SwinTransformer_base_patch4_window12_384_22kto1k_pretrained.pdparams'
    #     )
    #
    # input_tensor = paddle.randn((8, 3, 512, 512))
    # out_put = model(input_tensor)
